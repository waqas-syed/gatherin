...
{
    /// <summary>
    /// Asserts on the given vaues and throws exceptions if the value is not as expected
    /// </summary>
    public class Assertion
    {
        ...
        public static void AssertNumberNotZero(long currentNumber)
        {
            if (currentNumber == 0)
            {
                throw new InvalidOperationException("Given nuumber is 0");
            }
        }
        ...
        /// <summary>
        /// Checks that the given DateTime is not a MinValue
        /// </summary>
        /// <param name="dateTime"></param>
        public static void AssertDateIsNotMinValue(DateTime dateTime)
        {
            if (dateTime == DateTime.MinValue)
            {
                throw new InvalidOperationException("DateTime value is of minimum value");
            }
        }
    }
}
